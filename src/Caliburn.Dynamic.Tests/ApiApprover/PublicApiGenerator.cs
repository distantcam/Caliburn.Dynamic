    ...
    public static class PublicApiGenerator
    {
        ...
        public static string CreatePublicApiForAssembly(AssemblyDefinition assembly, Func<TypeDefinition, bool> shouldIncludeType, bool shouldIncludeAssemblyAttributes)
        {
            ...
            using (var provider = new CSharpCodeProvider())
            {
                ...
                var customUsings = new CodeNamespace();
                foreach (var u in Usings)
                {
                    customUsings.Imports.Add(new CodeNamespaceImport(u));
                }
                compileUnit.Namespaces.Add(customUsings);
        ...
        private static string NormaliseGeneratedCode(StringWriter writer)
        {
            ...
            gennedClass = Regex.Replace(gennedClass, @void, " void ", RegexOptions.IgnorePatternWhitespace);
        ...
        private static readonly HashSet<string> Usings = new HashSet<string>
        {
            "System",
