...
namespace Caliburn.Dynamic
{
    public static partial class PublicExtensions
    {
        ...
        public static IObservable<PropertyChangedData> WhenPropertiesChanged(this IObservablePropertyChanged changed, params string[] propertyNames) => changed.Changed.Where(p =>
            propertyNames.Contains(p.PropertyName));
